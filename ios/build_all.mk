...
PACKAGE  = $(LOCAL_MODULE)_$(TARGET_PLATFORM)_$(VERSION)_$(shell date +20%y%m%d%H%M%S).tar.gz
...
$(EXECUTABLE) : $(EXECUTABLE_IOS_DEV_ARMV7) $(EXECUTABLE_IOS_SIM_I386)
	lipo -output $@ -create -arch armv7 $(EXECUTABLE_IOS_DEV_ARMV7) -arch i386 $(EXECUTABLE_IOS_SIM_I386)
...
$(SHARED_LIBRARY) : $(SHARED_LIBRARY_IOS_DEV_ARMV7) $(SHARED_LIBRARY_IOS_SIM_I386)
	lipo -output $@ -create -arch armv7 $(SHARED_LIBRARY_IOS_DEV_ARMV7) -arch i386 $(SHARED_LIBRARY_IOS_SIM_I386)
...
$(STATIC_LIBRARY) : $(STATIC_LIBRARY_IOS_DEV_ARMV7) $(STATIC_LIBRARY_IOS_SIM_I386)
	lipo -output $@ -create -arch armv7 $(STATIC_LIBRARY_IOS_DEV_ARMV7) -arch i386 $(STATIC_LIBRARY_IOS_SIM_I386)
...
#
clean:
	rm -rf $(EXECUTABLE) $(EXECUTABLE_IOS_DEV_ARMV7) $(EXECUTABLE_IOS_SIM_I386)  $(STATIC_LIBRARY) $(STATIC_LIBRARY_IOS_DEV_ARMV7) $(STATIC_LIBRARY_IOS_SIM_I386) $(PACKAGE) $(OBJECTS_IOS_DEV_ARMV7) $(OBJECTS_IOS_SIM_I386)
