...
OBJECTS_IOS_DEV_ARMV7S = $(subst .c,_ios_dev_armv7s.o,$(subst .cpp,_ios_dev_armv7s.o,$(LOCAL_SRC_FILES)))
...
EXECUTABLE_IOS_DEV_ARMV7S = $(LOCAL_MODULE)_ios_dev_armv7s
...
STATIC_LIBRARY_IOS_DEV_ARMV7S = lib$(LOCAL_MODULE)_ios_dev_armv7s.a
...
SHARED_LIBRARY_IOS_DEV_ARMV7S = lib$(LOCAL_MODULE)_ios_dev_armv7s.dylib
...
%_ios_dev_armv7s.o : %.c
	$(CC_IOS_DEV) $(LOCAL_CFLAGS) $(CFLAGS_IOS_DEV_ARMV7S) -c $< -o $@
...
%_ios_dev_armv7s.o : %.cpp
	$(CXX_IOS_DEV) $(LOCAL_CXXFLAGS) $(CXXFLAGS_IOS_DEV_ARMV7S) -c $< -o $@
...
$(EXECUTABLE) : $(EXECUTABLE_IOS_DEV_ARMV7)  $(EXECUTABLE_IOS_DEV_ARMV7S) $(EXECUTABLE_IOS_SIM_I386)
	lipo -output $@ -create -arch armv7 $(EXECUTABLE_IOS_DEV_ARMV7) -arch armv7s $(EXECUTABLE_IOS_DEV_ARMV7S) -arch i386 $(EXECUTABLE_IOS_SIM_I386)
...
$(EXECUTABLE_IOS_DEV_ARMV7S) : $(OBJECTS_IOS_DEV_ARMV7S)
	$(CXX_IOS_DEV) $^ $(LOCAL_CXXFLAGS) $(CXXFLAGS_IOS_DEV_ARMV7S) $(LOCAL_LDFLAGS) $(LDFLAGS_IOS_DEV) -o $@
...
$(SHARED_LIBRARY) : $(SHARED_LIBRARY_IOS_DEV_ARMV7) $(SHARED_LIBRARY_IOS_DEV_ARMV7S) $(SHARED_LIBRARY_IOS_SIM_I386)
	lipo -output $@ -create -arch armv7 $(SHARED_LIBRARY_IOS_DEV_ARMV7) -arch armv7s $(SHARED_LIBRARY_IOS_DEV_ARMV7S) -arch i386 $(SHARED_LIBRARY_IOS_SIM_I386)

$(SHARED_LIBRARY_IOS_DEV_ARMV7) : $(OBJECTS_IOS_DEV_ARMV7)
	$(CXX_IOS_DEV) $^ $(LOCAL_CXXFLAGS) $(CXXFLAGS_IOS_DEV_ARMV7) $(LOCAL_LDFLAGS) $(LDFLAGS_IOS_DEV) -o $@

$(SHARED_LIBRARY_IOS_DEV_ARMV7S) : $(OBJECTS_IOS_DEV_ARMV7S)
	$(CXX_IOS_DEV) $^ $(LOCAL_CXXFLAGS) $(CXXFLAGS_IOS_DEV_ARMV7S) $(LOCAL_LDFLAGS) $(LDFLAGS_IOS_DEV) -o $@
...
$(STATIC_LIBRARY) : $(STATIC_LIBRARY_IOS_DEV_ARMV7) $(STATIC_LIBRARY_IOS_DEV_ARMV7S) $(STATIC_LIBRARY_IOS_SIM_I386)
	lipo -output $@ -create -arch armv7 $(STATIC_LIBRARY_IOS_DEV_ARMV7) -arch armv7 $(STATIC_LIBRARY_IOS_DEV_ARMV7S) -arch i386 $(STATIC_LIBRARY_IOS_SIM_I386)

$(STATIC_LIBRARY_IOS_DEV_ARMV7) : $(OBJECTS_IOS_DEV_ARMV7)
	$(AR_IOS_DEV) crv $@ $^

$(STATIC_LIBRARY_IOS_DEV_ARMV7S) : $(OBJECTS_IOS_DEV_ARMV7S)
	$(AR_IOS_DEV) crv $@ $^
...
#
clean:
	rm -rf $(EXECUTABLE) $(EXECUTABLE_IOS_DEV_ARMV7) $(EXECUTABLE_IOS_DEV_ARMV7S) $(EXECUTABLE_IOS_SIM_I386)  $(STATIC_LIBRARY) $(STATIC_LIBRARY_IOS_DEV_ARMV7) $(STATIC_LIBRARY_IOS_DEV_ARMV7S) $(STATIC_LIBRARY_IOS_SIM_I386) $(PACKAGE) $(OBJECTS_IOS_DEV_ARMV7) $(OBJECTS_IOS_DEV_ARMV7S) $(OBJECTS_IOS_SIM_I386)
