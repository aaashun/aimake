...
# use armv5, vfp 
CFLAGS   := -march=armv5te -mfloat-abi=softfp -mfpu=vfp -marm -fsigned-char -fpic -ffunction-sections -funwind-tables -fstack-protector -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__ -Wno-psabi -fomit-frame-pointer -fno-strict-aliasing -finline-limit=300 -DANDROID -Wa,--noexecstack -I$(PLATFORM)/usr/include -I$(ANDROID_NDK_HOME)/sources/android/cpufeatures
