...
# -fpic -mfpu=vfp
#
CFLAGS   := -fsigned-char -fpic -ffunction-sections -funwind-tables -fstack-protector -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__ -Wno-psabi -march=armv7-a -mfloat-abi=softfp -mfpu=neon -fomit-frame-pointer -fno-strict-aliasing -finline-limit=300 -DANDROID -Wa,--noexecstack -I$(PLATFORM)/usr/include 
...
LDFLAGS := -Wl,--fix-cortex-a8 -Wl,-z,nocopyreloc -Wl,--no-undefined -Wl,-z,noexecstack -Wl,--gc-sections --sysroot=$(PLATFORM) -L$(PLATFORM)/usr/lib -llog -lc -lsupc++
